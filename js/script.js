(function ($) {
  $(document).ready(function () {
    ...
    // #region by xianghongai@foxmail.com
    var chinese = [
      { key: '12月13日', value: '南京大屠杀死难者国家公祭日，和平呀和平，需要良知践行，需要力量捍卫！' },
      { key: '5月12日', value: '汶川大地震，人类很脆弱，敬畏自然！' },
      { key: '4月4日', value: 'COVID-19，众生平等！人类还有太多的未知和挑战！' }
    ]
    ...
    var today = dateNowMonth + '月' + dateNowDate + '日';

    chinese.some(function (history) {
      if (history.key === today) {
        document.querySelector('html').classList.add('don-t-forget');
        console.log('%s，%s', history.key, history.value);
        return true;
      }
    });
    // #endregion
